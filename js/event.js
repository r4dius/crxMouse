  ...
  function(response) {
    ...
    var cmg = {
      ...
      constinit: function() {
        ...
        cmg.valuestrmiddleenable = getConfig(
          "strokegesture",
          "strmiddleenable"
        );
        ...
        cmg.disrightopt =
          getConfig("normal", "cancelcontextmenu") &&
      ...
      init: function() {
        ...
        if (
          ...
          cmg.valuedrag ||
          cmg.valuescroll ||
          cmg.valuescrollgesture ||
          cmg.valuestrokegesture
        ) {
        ...
        switch (e.type) {
          case "mousedown":
            ...
            if (
              cmg.valuescrollgesture &&
              cmg.valuetablist &&
              ((cmg.valuetablistkey == "left" && e.button == 0) ||
                (cmg.valuetablistkey == "right" && e.button == 2))
            ) {
              cmg.toTablist = true;
            }
          ...
          case "mouseup":
            ...
            if (
              cmg.toStrges &&
              cmg.valuestrpress == "up" &&
              e.button != cmg.toStrkey
            ) {
              cmg.strtocancel = true;
              chrome.extension.sendMessage(
                {
            ...
            if (cmg.tablistIng) {
              ...
              if (window.top.document.getElementById("crxmousetablist")) {
                window.top.document
                  .getElementById("crxmousetablist")
                  .parentNode.removeChild(
                    window.top.document.getElementById("crxmousetablist")
                  );
              }
            }
            ...
            if (cmg.tablistIng) {
              if (document.getElementById("crxmousetablist")) {
                document
                  .getElementById("crxmousetablist")
                  .parentNode.removeChild(
                    document.getElementById("crxmousetablist")
                  );
              }
              e.preventDefault();
              cmg.tablistIng = false;
          ...
          case "dragstart":
            /*fixed svgdiv*/
            if (
              document.getElementById("svgdivmjidkpedjlfnanainpdfnedkdlacidla")
            ) {
              document
                .getElementById("svgdivmjidkpedjlfnanainpdfnedkdlacidla")
                .parentNode.removeChild(
                  document.getElementById(
                    "svgdivmjidkpedjlfnanainpdfnedkdlacidla"
                  )
                );
            }

            if (
              !e[cmg.valuedholdkey + "Key"] &&
              !tostop &&
              (cmg.valuedrag || teststroke)
            ) {
              this.toDrag = true;
              this._dragstart(e);
            }
          ...
          case "mousewheel":
            ...
            if (cmg.toTablist && ud != "") {
              ...
              chrome.extension.onMessage.addListener(function(
                ...
                //alert("xxx");
                if (
                  request.type == "tablist" &&
                  !window.top.document.getElementById("crxmousetablist")
                ) {
                  var _tablisthold = window.top.document.createElement("div");
                  _tablisthold.id = "crxmousetablist";
                  _tablisthold.style.left =
                    (window.top.innerWidth - 400) / 2 + "px";
                  _tablisthold.style.top =
                    (window.top.innerHeight - request.tabs.length * 28) / 2 +
                    "px";
                  ...
                  window.top.document.getElementsByClassName(
                    "crxmousetablisttab"
                  )[request.curTab.index].id = "crxmousetablisttabcurrent";
                  e.preventDefault();
              ...
              if (e.wheelDeltaY < 0) {
                var _tabobj = window.top.document.getElementsByClassName(
                  "crxmousetablisttab"
                );
                ...
                for (var i = 0; i < _tabobj.length; i++) {
                  if (_tabobj[i].id == "crxmousetablisttabcurrent") {
                    _tabobj[i].id = "";
                    if (i == 0) {
                      _tabobj[_tabobj.length - 1].id =
                        "crxmousetablisttabcurrent";
            ...
            do {
              if (
                ...
                if (
                  ...
                  var overflow = getComputedStyle(target, "").getPropertyValue(
                    "overflow"
                  );
                  if (
                    overflow === "scroll" ||
                    overflow === "auto" ||
                    (target.tagName === Root.tagName && overflow !== "hidden")
                  ) {
              ...
              if (scroll_object && scroll_object.isScrollable(dir)) {
                ...
                if (true) {
                  ...
                  var accele =
                    (1 -
                      Math.min(Math.log(now - prev + 1), LOG_SEC) / LOG_SEC) *
                      AccelerationValue +
                    1;
                  x *= accele;
                  y *= accele;
                ...
                var ax = Math.abs(x),
                  ay = Math.abs(y);
                scroll_object.scroll(
                  x,
                  y,
                  Math.log(Math.max(ax, ay)) *
                  (1.1 -
                    cmg.valuescrollspeed *
                      0.1) /*this.config.ScrollSpeedValue*/ *
                    100
                );
                /*scroll speed*/
                e.preventDefault();
      ...
      _progressGesture: function(e) {
        ...
        if (direction != lastDirection) {
          ...
          if (
            !document.getElementById(
              "infoshowmjidkpedjlfnanainpdfnedkdlacidla"
            ) &&
            (teststroke ||
              (cmg.valuegestureui && (cmg.valuedirect || cmg.valuetooltip)))
          ) {
            var _infoshow = document.createElement("div");
            _infoshow.id = "infoshowmjidkpedjlfnanainpdfnedkdlacidla";
            _infoshow.style.width =
              Math.min(
                document.documentElement.scrollWidth,
                window.innerWidth
              ) + "px";
            _infoshow.style.height =
              Math.max(
            ...
            if (cmg.valuedirect || teststroke) {
              ...
              document
                .getElementById("infoshowmjidkpedjlfnanainpdfnedkdlacidla")
                .appendChild(_dirshow);
            }
            ...
            if (cmg.valuetooltip || teststroke) {
              ...
              if (cmg.valuedirect || teststroke) {
                ...
                _tipshow.style.marginTop =
                  (window.innerHeight / 5) * 2 + 35 + "px";
              }
              document
                .getElementById("infoshowmjidkpedjlfnanainpdfnedkdlacidla")
                .appendChild(_tipshow);
            }
          }

          if (
            (cmg.valuedirect || teststroke) &&
            document.getElementById("dirshowmjidkpedjlfnanainpdfnedkdlacidla")
          ) {
            var _dirlength = this._directionChain.length;
            document.getElementById(
              "dirshowmjidkpedjlfnanainpdfnedkdlacidla"
            ).style.width =
              Math.min(32 * (_dirlength + 1), window.innerWidth) + "px";
            document.getElementById(
              "dirshowmjidkpedjlfnanainpdfnedkdlacidla"
            ...
            _showimg.src =
              ...
              ".png";
            document
              .getElementById("dirshowmjidkpedjlfnanainpdfnedkdlacidla")
              .appendChild(_showimg);
          }

          if (
            (cmg.valuetooltip || teststroke) &&
            document.getElementById("tipshowmjidkpedjlfnanainpdfnedkdlacidla")
          ) {
            chrome.extension.sendMessage(
              {
                type: "tipshow",
              ...
              function(response) {
                if (response.moreDes != "none") {
                  document.getElementById(
                    "tipshowmjidkpedjlfnanainpdfnedkdlacidla"
                  ).innerHTML = response.moreDes;
                } else {
                  document.getElementById(
                    "tipshowmjidkpedjlfnanainpdfnedkdlacidla"
                  ).innerHTML = "";
      ...
      _dragstart: function(e) {
        ...
        if (teststroke) {
          document
            ...
            .removeChild(document.getElementById("adddirect"));
        }
        this._lastX = e.clientX;
        this._lastY = e.clientY;
        this._directionChain = "";
        ...
        switch (e.target.nodeType) {
          ...
          case 1:
            if (e.target.value && cmg.valuedragtext && cmg.valuedraginput) {
              ...
              if (1) {
                //fix selection & drag to search & open link strategy
              ...
              if (e.target.parentNode.href) {
                if (
                  cmg.valuedragimage &&
                  (e[cmg.valueimgfirst + "Key"] || cmg.valueimgfirstcheck)
                ) {
      ...
      _dragprogress: function(e) {
        ...
        if (
          ...
          (teststroke ||
            (cmg.valuedragui && (cmg.valueddirect || cmg.valuedtooltip)))
        ) {
          var _infoshow = document.createElement("div");
          _infoshow.id = "infoshowmjidkpedjlfnanainpdfnedkdlacidla";
          _infoshow.style.width =
          ...
          if (cmg.valueddirect || teststroke) {
            var _dirshow = document.createElement("div");
            _dirshow.id = "dirshowmjidkpedjlfnanainpdfnedkdlacidla";
            _dirshow.style.backgroundColor = cmg.valueddirectcolor;
          ...
          if (cmg.valuedtooltip || teststroke) {
            var _tipshow = document.createElement("div");
            _tipshow.id = "tipshowmjidkpedjlfnanainpdfnedkdlacidla";
            _tipshow.style.fontSize = cmg.valuedtooltipwidth + "px";
            _tipshow.style.opacity = cmg.valuedtooltipopa;
            _tipshow.style.color = cmg.valuedtooltipcolor;
        ...
        if (dx < cmg.valueminlength || dy < cmg.valueminlength) {
          if (cmg.valuedragui && (cmg.valuedstroke || teststroke)) {
            if (
              !document.getElementById("svgdivmjidkpedjlfnanainpdfnedkdlacidla")
            ) {
              var svgdiv = (this.svgdiv = document.createElement("div"));
        ...
        if (direction != lastDirection) {
          ...
          if (
            (cmg.valueddirect || cmg.valuedtooltip || teststroke) &&
            document.getElementById("infoshowmjidkpedjlfnanainpdfnedkdlacidla")
          ) {
            document.getElementById(
              "infoshowmjidkpedjlfnanainpdfnedkdlacidla"
            ).style.cssText += "z-index:100000 !important";
          }
        }
      ...
      _strokeclear: function() {
        ...
        if (document.getElementById("crxmousecanvas")) {
          document
            .getElementById("crxmousecanvas")
            .parentNode.removeChild(document.getElementById("crxmousecanvas"));
        }
          ...
          case "G_bottom":
            ...
            if (_N > 2) {
              ...
              window.scrollBy(
                ...
                _alllength - 2 * window.innerHeight
              );
            }
            var _timer = window.setInterval(function() {
              ...
              for (var j = 0; j < htmlchar.length; j++) {
                function _objreplace() {
                  if (_innerobj[i].indexOf(htmlchar[j]) != -1) {
                    _innerobj[i] = _innerobj[i].replace(
                      htmlchar[j],
                      htmlinner[j]
                    );
                    _objreplace();
    ...
    function SmoothScrollByElement(target) {
      this.target = target;
      this._target =
        target === document.documentElement ? document.body : target;
    }
    ...
    SmoothScrollByElement.prototype = {
      scroll: function(_x, _y, _duration) {
        ...
        function scroll() {
          ...
          if (
            time > duration ||
            (!isDown && _target.scrollTop === 0) ||
            (isDown &&
              _target.scrollTop + target.clientHeight + 16 >=
                target.scrollHeight)
          ) {
            self.fin();
...
chrome.extension.onMessage.addListener(function(request, sender, sendResponse) {
  if (
    ...
    window.setTimeout(function() {
      if (
        document.getElementById("notifiboxmjidkpedjlfnanainpdfnedkdlacidla")
      ) {
        document
          .getElementById("notifiboxmjidkpedjlfnanainpdfnedkdlacidla")
          .parentNode.removeChild(
            document.getElementById("notifiboxmjidkpedjlfnanainpdfnedkdlacidla")
          );
      }
  ...
  function addnotifibox() {
    var _obj = document.getElementById(
      "notifiboxmjidkpedjlfnanainpdfnedkdlacidla"
    );
    if (_obj) {
